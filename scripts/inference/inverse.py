...
from src.pipelines.pipeline_origin import (
...
def main(args):
    ...
    for num_round in range(1, args.rounds+1):
        ...
        for step, batch in enumerate(dataloader):
            ...
            # NOTE SG: "real" -> "comp"
            eval_gt_images = batch[args.resolution]["comp"]
            ...
            for i, sample in enumerate(samples):
                ...
                # NOTE SG: "real" -> "comp"
                sample = replace_background(to_tensor(sample), batch[args.output_resolution]["comp"][i].add(1).div(2), batch[args.output_resolution]["mask"][i])
